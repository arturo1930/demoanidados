...
describe('Service Tests', () => {
  describe('Institucion Service', () => {
    ...
    beforeEach(() => {
      service = new InstitucionService();
      elemDefault = new Institucion('ABC', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Institucion', async () => {
      ...
      it('should not update a Institucion', async () => {
      ...
      it('should partial update a Institucion', async () => {
      ...
      it('should not partial update a Institucion', async () => {
      ...
      it('should not return a list of Institucion', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Institucion', async () => {

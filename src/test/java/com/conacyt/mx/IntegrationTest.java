...
import com.conacyt.mx.DemoanidadosApp;
import com.conacyt.mx.config.AsyncSyncConfiguration;
import com.conacyt.mx.config.EmbeddedMongo;
...
@SpringBootTest(classes = { DemoanidadosApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
